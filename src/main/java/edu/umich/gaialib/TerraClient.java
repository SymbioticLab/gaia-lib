...
public class TerraClient {
     ...
     * Say hello to server.
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.umich.gaialib.gaiaprotos.HelloReply> greet(String name) {
        logger.info("TerraClient.greet called!!!");
        HelloRequest request = HelloRequest.newBuilder().setName(name).build();
        com.google.common.util.concurrent.ListenableFuture<edu.umich.gaialib.gaiaprotos.HelloReply> helloReplyFuture =
                futureStub.sayHello(request);

        /** example of how to use future in spark
        while(!helloReplyFuture.isDone()) {
        ...
        try {
            edu.umich.gaialib.gaiaprotos.HelloReply helloReply = helloReplyFuture.get();
